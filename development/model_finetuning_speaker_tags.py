...
if __name__ == '__main__':
    ...
    # Temporarily keeping these in separate py files -- will merge to argparse if needed.
    # This is basically the same sa the replication code.
    ...
    trainer = get_trainer(this_model, this_tokenizer, model_save_path, with_tags = True)
