...
def call_single_across_time_model(sample_dict, all_tokens_phono, model_class, this_split, this_dataset_name, is_tags, context_width, examples_mode):
    ...
    for idx, age_str in enumerate(ages):
        ...
        this_scores = sample_models_across_time.successes_and_failures_across_time_per_model(age, this_success_pool.utterance_id, this_yyy_pool.utterance_id, this_model_dict, all_tokens_phono, optimal_beta, examples_mode)
...
if __name__ == '__main__':
    ...
    scores = call_single_across_time_model(this_sample_dict, all_phono, this_args['model_type'], this_args['split'], this_args['dataset'], this_args['use_tags'], this_args['context_width'], this_args['examples_mode'])
