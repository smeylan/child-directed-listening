...
def call_single_across_time_model(sample_dict, all_tokens_phono, model_class, this_split, this_dataset_name, is_tags, context_width, examples_mode):
    ...
    optimal_beta = hyperparameter_utils.get_optimal_hyperparameter_value_with_dict(this_split, this_dataset_name, beta_model_dict, model_class, 'beta')
    optimal_lambda = hyperparameter_utils.get_optimal_hyperparameter_value_with_dict(this_split, this_dataset_name, lambda_model_dict, model_class, 'lambda')
