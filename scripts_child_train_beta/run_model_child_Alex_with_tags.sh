...
singularity exec --nv -B /om,/om2/user/wongn /om2/user/wongn/vagrant/trans-pytorch-gpu     python3 run_mlm.py             --model_name_or_path bert-base-uncased             --do_train             --do_eval             --output_dir /om2/user/wongn/child-directed-listening/experiments/no_versioning/models/child/Alex/with_tags            --train_file /om2/user/wongn/child-directed-listening/finetune/child/Alex/train.txt             --validation_file /om2/user/wongn/child-directed-listening/finetune/child/Alex/val.txt             --cache_dir ~/.cache/$SLURM_JOB_ID             --overwrite_output_dir; python3 run_beta_search.py --split child --dataset Alex --context_width 0 --use_tags True --model_type childes