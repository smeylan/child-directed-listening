...
singularity exec --nv -B /om,/om2/user/wongn /om2/user/wongn/vagrant/trans-pytorch-gpu     python3 run_mlm.py             --model_name_or_path bert-base-uncased             --do_train             --do_eval             --output_dir /om2/user/wongn/child-directed-listening/experiments/no_versioning/models/child/Naima/with_tags            --train_file /om2/user/wongn/child-directed-listening/finetune/child/Naima/train.txt             --validation_file /om2/user/wongn/child-directed-listening/finetune/child/Naima/val.txt             --cache_dir ~/.cache/$SLURM_JOB_ID	 --model_name_or_path /om2/user/wongn/child-directed-listening/experiments/no_versioning/models/all/all/with_tags; singularity exec --nv -B /om,/om2/user/wongn /om2/user/wongn/vagrant/trans-pytorch-gpu  python3 run_beta_search.py --split child --dataset Naima --context_width 0 --use_tags True --model_type childes
