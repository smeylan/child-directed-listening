...
singularity exec --nv -B /om,/om2/user/wongn /om2/user/wongn/vagrant/trans-pytorch-gpu python3 run_models_across_time_default.py --split age --dataset young --context_width 20 --use_tags True --model_type childes