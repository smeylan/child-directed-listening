...
#SBATCH --output=/om2/user/wongn/child-directed-listening/experiments/goal_to_convergence/scores/n=500/val/age/young/%j_non_child_beta_time_model=childes_tags=False_context=20.out
