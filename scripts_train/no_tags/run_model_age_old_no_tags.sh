...
singularity exec --nv -B /om,/om2/user/wongn /om2/user/wongn/vagrant/trans-pytorch-gpu python3 run_mlm.py --train_file /om2/user/wongn/child-directed-listening/finetune/age/old/train_no_tags.txt --validation_file /om2/user/wongn/child-directed-listening/finetune/age/old/val_no_tags.txt --cache_dir ~/.cache/$SLURM_JOB_ID --do_eval  --do_train  --eval_steps 500 --evaluation_strategy steps --learning_rate 0.0005 --load_best_model_at_end  --logging_steps 500 --logging_strategy steps --metric_for_best_model eval_loss --model_name_or_path bert-base-uncased --num_train_epochs 5 --overwrite_output_dir  --per_device_eval_batch_size 128 --per_device_train_batch_size 128 --save_steps 500 --save_strategy steps --save_total_limit 1
