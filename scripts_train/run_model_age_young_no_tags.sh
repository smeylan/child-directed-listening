...
singularity exec --nv -B /om,/om2/user/wongn /om2/user/wongn/vagrant/trans-pytorch-gpu     python3 run_mlm.py             --model_name_or_path bert-base-uncased             --do_train             --do_eval             --output_dir /om2/user/wongn/child-directed-listening/experiments/no_versioning/models/age/young/no_tags            --train_file /om2/user/wongn/child-directed-listening/finetune/age/young/train_no_tags.txt             --validation_file /om2/user/wongn/child-directed-listening/finetune/age/young/val_no_tags.txt             --cache_dir ~/.cache/$SLURM_JOB_ID	--overwrite_output_dir
