...
singularity exec --nv -B /om,/om2/user/wongn /om2/user/wongn/vagrant/trans-pytorch-gpu     python3 run_mlm_lr_0.001_max_epochs_5.py.py             --model_name_or_path bert-base-uncased             --do_train             --do_eval             --output_dir /om2/user/wongn/child-directed-listening/experiments/scripts_train_lr_0.001_epochs_5/models/all/all/with_tags            --train_file /om2/user/wongn/child-directed-listening/finetune/all/all/train.txt             --validation_file /om2/user/wongn/child-directed-listening/finetune/all/all/val.txt             --cache_dir ~/.cache/$SLURM_JOB_ID	--overwrite_output_dir
